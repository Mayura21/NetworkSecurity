...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data ingestion complete and artifacts are {data_ingestion_artifact}")
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact):
        try:
            ...
            logging.info(f"Model training complete and artifacts are {model_trainer_artifact}")
            return model_trainer_artifact
        except Exception as e:
            raise NetworkSecurityException(e, sys)

    # Local artifact to s3 bucket
    def sync_artifact_dir_to_s3(self):
        try:
            TRAINING_BUCKET_NAME = "nsecurity"
